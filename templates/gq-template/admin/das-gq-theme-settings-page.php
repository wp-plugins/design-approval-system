...
<div class="das-settings-admin-wrap" id="theme-settings-wrap">
  ...
  <form method="post" class="das-settings-admin-form" action="options.php">
    ...
    <div class="das-gq-theme-settings-admin-input-wrap company-info-style das-gq-theme-turn-on-custom-colors das-settings-admin-input-wrap company-info-style">
      <div class="das-gq-theme-settings-admin-input-label das-gq-theme-wp-header-custom"><p class="special"><?php _e('Check the box to turn ON the custom padding option for the DAS GQ Theme Plugin. This will make it so the menu and content fits nicely within your website. Simply define the numbers to suite your desired spacing. Here is how it works. 25px 20px 25px 30px. Lets break it down now. 25px = top padding, 20px = right padding, 25px = bottom padding and 30px = left padding. <br/><br/>The same idea applies to the margin option. However, if you set a Max-Width for the Main GQ Theme Wrapper too we can add auto to the left and right margin so the frame will be positioned in the middle of the screen. Give it a try!', 'design-approval-system'); ?></p></div>
    <p>
