...
$custom_meta_fields_tab6[0] =	array(
				...
				'options' => array (
					'one' => array (
						'label' => __('Default Template', 'design-approval-system'),
...
// if statement for array. Allows us to add additional themes to the select option.
if(is_plugin_active('das-clean-theme/das-clean-theme.php')) { 
		  $custom_meta_fields_tab6[0]['options']['two'] =	array(
				  'label' => __('Clean Theme Template', 'design-approval-system'),
				  'value'	=> 'das-clean-theme-main.php', 'design-approval-system'
		  );				
}
// if statement for array. Allows us to add additional themes to the select option.
if(is_plugin_active('das-gq-theme/das-gq-theme.php')) { 
	// TAB6
	 $custom_meta_fields_tab6[0]['options']['three'] =	array(
						  'label' => __('GQ Theme Template', 'design-approval-system'),
						  'value'	=> 'das-gq-theme-main.php', 'design-approval-system'
				  );
}
...
$custom_meta_fields_tab7[] = array(
		...
		'desc'	=> __('By filling this out you will override the default Terms &amp; Conditions filled out on the GQ Theme Settings Page for only this post.', 'design-approval-system'),
...
echo '<input type="hidden" name="custom_meta_box_nonce" value="'.wp_create_nonce(basename(__FILE__)).'" />'; ?>
 ...
 <div class="das-tabs-back"></div> 
  ...
  <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header">
    ...
    <?php if(is_plugin_active('das-design-login/das-design-login.php')) { ?><li id="das-id-4"><a href="#das-tabs-4"><?php _e('Custom Login', 'design-approval-system') ?></a></li><?php } ?>
    <?php if(is_plugin_active('woocommerce-for-das/woocommerce-for-das.php')) { ?><li id="das-id-5"><a href="#das-tabs-5"><?php _e('Product Info', 'design-approval-system') ?></a></li><?php } ?>
    <li id="das-id-6"><a href="#das-tabs-6"><?php _e('Template', 'design-approval-system') ?></a></li>
