	...
	'order'                    => 'ASC',
		   ...
		   $my_query = new WP_Query($args);
						...
						if( $my_query->have_posts() ) : ?>
							<?php while ( $my_query->have_posts() ) : $my_query->the_post(); global $post; 
								...
								if(($term_value == $final_client_value) && ($key == $final_term_value)) {?>
                                             ...
                                             <a href='<?php the_permalink();?>' title='<?php the_title_attribute(); ?>' class='project-list-link'><?php echo get_post_meta($post->ID, 'custom_version_of_design', true); ?></a>
                                             </div>	
                ...
                <div class='project-notes-text-header'>Details</div>
				 ...
				 <strong>Post Name:</strong> <a href='<?php the_permalink();?>' title='<?php the_title_attribute(); ?>'><?php the_title(); ?></a><br/>
