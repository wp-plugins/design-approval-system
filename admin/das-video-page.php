...
<div class="iframe-wrap">
  <h3><a href="http://www.slickremix.com/product/design-login-das-extension/" target="_blank"><?php _e('Design Login, Premium Extension', 'design-approval-system') ?></a></h3>
  <iframe width="600" height="450" src="http://www.youtube.com/embed/qCU1fjP6Z78" frameborder="0" allowfullscreen></iframe>
</div>
<div class="iframe-wrap">
  <h3><a href="http://www.slickremix.com/product/select-user-and-email-extension/" target="_blank"><?php _e('Select User and Email, Premium Extension', 'design-approval-system') ?></a></h3>
...
<div class="iframe-wrap iframe-odd">
  <h3>Design Approval System & <a href="http://www.slickremix.com/product/client-changes-extension/" target="_blank"><?php _e('Client Changes, Premium Extension</a> - Full Tutorial', 'design-approval-system') ?></h3>
